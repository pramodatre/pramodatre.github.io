...
date: '2020-11-06'
categories: ['UAV', 'guided navigation']
draft: false
---
...
![Backyard Flyer project working with FCND simulator](backyard_flyer_solution.gif)
...
![Connect to Crazyflie using `cfclient` UI](cfclient_config_1.gif)

Once connected, it is recommended to change the connection bandwidth from `250k` to `2M`.

![Change bandwidth of Crazyflie connection to recommended `2M`](cfclient_config_2.gif)
...
![Crazyflie flying a square trajectory of side 0.75 meters](crazyflie_backyard_flyer.gif)
