...
date: '2021-02-12'
categories: ['baby monitor', 'raspberry pi', 'usb camera', 'usb microphone']
draft: false
---
...
![WebRTC page displaying the stream of the USB camera](webrtc_with_streams.png)
